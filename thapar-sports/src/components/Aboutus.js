    ...
    return (
        <div>
            <div class="container-fluid" id="aboutfront">
                <img id="synthetic" src="img/synthetic.jpeg" alt="Track"/>
            ...
            <div class="bg-white py-5">
                <div class="container py-5">
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="img/synthetic.jpeg" alt=""
                            class="img-fluid mb-4 mb-lg-0" id="photo_track"/></div>
                    </div>
                    <br></br><br></br><br></br>
                        <div class="row align-items-center">
                            <div class="col-lg-5 px-5 mx-auto"><img src="img//CRICKET_GROUND.jpg" alt="" class="img-fluid mb-4 mb-lg-0" id="photo_ground"/>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="bg-white py-5">
                            <div class="container py-5">
                                <div class="row align-items-center mb-5">
                                    ...
                                    <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="img/ach1sp.jpg" alt=""
                                        class="img-fluid mb-4 mb-lg-0" id="photo_boyz"/></div>
                                </div>
                                <br></br><br></br>
                                    <div class="row align-items-center">
                                        <div class="col-lg-5 px-5 mx-auto"><img src="img/thpppp.jpeg" alt="" class="img-fluid mb-4 mb-lg-0" id="photo_thpp"/>
                                        </div>
                                        <div class="col-lg-6">
